...
namespace wasd314
{
    ...
    namespace solver
    {
        ...
        std::vector<solution_t> re1_bs_div(u128 n, int e, const std::map<u128, int> &pe_n)
        {
            using namespace factorization;
            using solver_util::bisect_left;
        ...
        void solve(u128 n)
        {
            ...
            auto pe_n = to_freq(factorize(n));
            answers.push_back(r13_pe(n, 1, pe_n));
            answers.push_back(re1_bs_div<true>(n, 2, pe_n));
            answers.push_back(re1_bs_div<true>(n, 3, pe_n));
            answers.push_back(re1_bs_div<true>(n, 4, pe_n));
            for (int e = 5; (n >> e) != 0; ++e) {
