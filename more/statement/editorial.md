...
本問題の制約下における $d(6N, W_\text{max})$ の最大値は，$N = 985\,496\,152\,350\,226\,952\,635\,200$ のときの $126\,085$ と思われます（未証明）．$126\,264$ 以下であることは証明されています．
...
本問題の制約下における $d(2N, W_\text{max}')$ の最大値は，$N = 985\,496\,152\,350\,226\,952\,635\,200$ のときの $24\,176$ と思われます（未証明）．$24\,213$ 以下であることは証明されています．
...
それぞれ列挙でき，$d(n, k) \le d(n, n) \in o(n^{1/4})$ であるため，合わせて期待 $O( N^{1/4} )$ 時間でこの問題を解くことができます．
