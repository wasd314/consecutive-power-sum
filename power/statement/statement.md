...
{{ import_sample_input(file="../rime-out/tests/00_sample_2024.in") }}
{{ import_sample_output(file="../rime-out/tests/00_sample_2024.diff") }}
...
$(2, 45, 45)$ の方が $(3, 1, 9)$ より辞書式順序で小さいので，この順に出力してください．
